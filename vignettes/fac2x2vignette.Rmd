...
is a 4600-by-9 matrix which is loaded with the `factorial2x2` package.  `simdata` corresponds to a simulated 2x2 factorial clinical trial of 4600 subjects. Subjects are simultaneously randomized to receive either treatment *A* or placebo as well as either treatment *B* or placebo.
...
$seab
[1] 0.09553005              # std error of the log HR estimate for the simple effect of naltrexone and CBI
